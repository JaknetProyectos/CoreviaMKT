...
export default function DevolucionesPage() {
  ...
  const content = {
    es: {
      ...
      intro:
        "Esta política aplica a todos los planes y proyectos digitales contratados a través de coreviamkt.com con la Empresa (“la Empresa”), incluyendo, pero no limitado a: planes de sitios web, tiendas en línea, plataformas especializadas, planes de branding + web y proyectos digitales a la medida.",
      sections: [
        {
        ...
        },
        {
          ...
          body: [
            "Para solicitar una cancelación o plantear un posible reembolso, el Cliente deberá escribir a hola@coreviamkt.com indicando:",
    ...
    en: {
      ...
      intro:
        "This policy applies to all digital plans and projects contracted through coreviamkt.com with the Company (“the Company”), including, but not limited to: website plans, online stores, specialized platforms, branding + web plans, and custom digital projects.",
      sections: [
        {
        ...
        },
        {
          ...
          body: [
            "To request a cancellation or raise a possible refund, the Client must write to hola@coreviamkt.com indicating:",
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#f5f7f2] py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto -mt-5 max-w-5xl px-3 sm:px-6">
          <div className="relative rounded-3xl border border-[#183c34]/10 bg-white/90 p-6 shadow-[0_25px_60px_-35px_rgba(16,46,40,0.4)] backdrop-blur-xl sm:p-8">
            <div className="absolute left-0 top-8 h-12 w-1 rounded-r-full bg-[#56c5a8]" />

            <p className="pl-3 text-[0.98rem] leading-8 text-[#334b45] sm:text-base">
              {t.intro}
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto mt-14 max-w-5xl rounded-3xl bg-[#102e28] px-6 py-8 text-center sm:px-10">
          <p className="text-sm leading-7 text-white/70">
            {lang === "en"
              ? "For questions about this policy, contact our team at"
              : "Para resolver dudas relacionadas con esta política, contacta a nuestro equipo en"}
          </p>

          <a
            href="mailto:hola@coreviamkt.com"
            className="mt-2 inline-block text-lg font-semibold text-[#d8ff65] transition hover:text-white"
          >
            hola@coreviamkt.com
          </a>
        </div>
